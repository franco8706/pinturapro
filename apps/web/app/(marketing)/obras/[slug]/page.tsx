...
export default async function ProjectPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const hasImage = cover?.startsWith("http");
        ...
        <div className="container-asymmetric">
          ...
          <div className="flex flex-wrap gap-6">
            <div className="flex items-center gap-3">
              <div className="w-16 h-16 bg-bone" />
              <div>
                <p className="font-display text-body-lg text-bone">Base</p>
                <p className="font-mono text-mono-sm text-bone/70">#FFFFFF</p>
              </div>
            </div>
            <div className="flex items-center gap-3">
              <div className="w-16 h-16" style={{ backgroundColor: project.accentColor, filter: "brightness(1.3)" }} />
              <div>
                <p className="font-display text-body-lg text-bone">Principal</p>
                <p className="font-mono text-mono-sm text-bone/70">{project.accentColor}</p>
              </div>
            </div>
            <div className="flex items-center gap-3">
              <div className="w-16 h-16 bg-ink" />
              <div>
                <p className="font-display text-body-lg text-bone">Contraste</p>
                <p className="font-mono text-mono-sm text-bone/70">#141414</p>
              </div>
            </div>
          </div>
        </div>
